            ...
            <Chakra.Grid w="100%" pos={'fixed'} zIndex={9} bg="white" top={0} left={0} boxShadow={'sm'} height="70px" px={5} >
                ...
                <Chakra.Flex alignItems="center">
                    ...
                    <Chakra.Flex flex={1}>
                        ...
                        <Chakra.Button _hover={{ bg: 'whitesmoke' }} ref={btnRef} onClick={onOpen} mx={1} variant={'unstyled'} display="flex" justifyContent={'center'}>
                    ...
                    <Chakra.Flex flex={1} alignItems='center' justifyContent='end'>
                        ...
                        <Chakra.Button _hover={{ bg: 'whitesmoke' }} display={'flex'} alignItems="center" justifyContent={'center'} tabIndex={1} ml={5} variant={'unstyled'} onClick={Model.onOpen}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black" viewBox="0 0 16 16">
                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                            </svg>
                        </Chakra.Button>

                        <Chakra.Button _hover={{ bg: 'whitesmoke' }} display={'flex'} alignItems="center" justifyContent={'center'} ml={5} variant={'unstyled'} onClick={onCartClickHandler}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black" viewBox="0 0 16 16">
